...
The System cannot compel participation, require observation, enforce transmutation, assert truth, or guarantee completeness. It does not assume compliance, trust, or data quality. Any such constraints, if desired, must be introduced deliberately as *Rules* or *Subsystems* defined by an Alchemist.
